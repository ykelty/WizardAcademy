...
public class Maker25 extends BaseMaker {
  ...
  public static MultipleChoiceQuestion makeQuestion(String var2,String var3,String var4, String var5){
   ...
   q="Is the following triangle acute, right or obtuse ? <br>";

   String blockpath = "images/geometry/triangle/";
   if (random==1){
     //come with an acute angle
     int n1 = Helper.getRandom(1, 20);
   ...
   options.add("a. "+ "acute triangle");
   options.add("b. "+ "right triangle");
   options.add("c. "+ "obtuse triangle");
